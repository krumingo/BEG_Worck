...
export default function EmployeesPage() {
  ...
  const [createForm, setCreateForm] = useState({
    first_name: "", middle_name: "", last_name: "", email: "", phone: "", role: "Technician",
    password: "", position: "",
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1 grid grid-cols-3 gap-3">
                ...
                <div className="space-y-1"><Label className="text-xs">Презиме</Label><Input value={createForm.middle_name} onChange={e => setCreateForm({...createForm, middle_name: e.target.value})} className="bg-background" data-testid="create-middle-name" /></div>
              ...
              <div className="space-y-1">
                ...
                <Select value={createForm.role} onValueChange={v => setCreateForm({...createForm, role: v})}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Warehousekeeper">Складар</SelectItem>
                    <SelectItem value="Driver">Шофьор</SelectItem>
                    <SelectItem value="Viewer">Преглед само</SelectItem>
                  </SelectContent>
                </Select>
              </div>
