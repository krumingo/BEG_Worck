...
| W0-03 Master Data | **W0-03A MERGED — W0-03B1 IN PROGRESS** | инвентар и implementation contract: [W0-03_MASTER_DATA_INVENTORY_AND_CONTRACT.md](W0-03_MASTER_DATA_INVENTORY_AND_CONTRACT.md) (20.09.2026) — 15 идентичностни колекции, 0 уникални индекса върху master data, `persons`/`companies` с по два писача и различни схеми | целият runtime обхват; няма `app/master_data`; A–E разделянето чака независимо ревю и възлагане |
