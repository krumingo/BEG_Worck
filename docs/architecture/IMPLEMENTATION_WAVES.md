...
| W0-03 Master Data | **W0-03B1 MERGED — W0-03B2 IN PROGRESS** | инвентар и implementation contract: [W0-03_MASTER_DATA_INVENTORY_AND_CONTRACT.md](W0-03_MASTER_DATA_INVENTORY_AND_CONTRACT.md) (20.09.2026) — 15 идентичностни колекции, 0 уникални индекса върху master data, `persons`/`companies` с по два писача и различни схеми | остава B3 (човешко resolve на pending) и C–E (нормализация, уникалност, merge, миграция). `app/master_data` съществува, но е инертен: `MASTER_DATA_MODE` по подразбиране е `off` и нито един legacy route не е вързан |
