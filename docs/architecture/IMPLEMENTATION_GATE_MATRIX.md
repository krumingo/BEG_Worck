...
| 032 | W0-03 | **W0-03B1 MERGED — B2/B3/C(min) IN REVIEW** | целият runtime обхват. Инвентарът (`W0-03_MASTER_DATA_INVENTORY_AND_CONTRACT.md`) показва 15 идентичностни колекции, нула уникални индекса върху master data, дублирани писачи на `persons`/`companies` и седем нескоупнати изтривания |
