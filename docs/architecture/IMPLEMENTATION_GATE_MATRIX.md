...
| 032 | W0-03 | **W0-03B1 MERGED — W0-03B2 IN PROGRESS** | целият runtime обхват. Инвентарът (`W0-03_MASTER_DATA_INVENTORY_AND_CONTRACT.md`) показва 15 идентичностни колекции, нула уникални индекса върху master data, дублирани писачи на `persons`/`companies` и седем нескоупнати изтривания |
