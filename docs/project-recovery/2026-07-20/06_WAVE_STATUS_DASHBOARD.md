...
| W0-03 | Master Data / FLOW-032 | **W0-03A MERGED — W0-03B1 IN PROGRESS** | contract merge-нат в `main` (`d8a213a3`, 20.09.2026); тече B1 — основата на `app/master_data` и доказателство за инертен `off` режим, в отделен Draft PR | целият останал runtime обхват (B2–E); нито един legacy route не е вързан; aliases/uniqueness/merge/миграция са C–E |
