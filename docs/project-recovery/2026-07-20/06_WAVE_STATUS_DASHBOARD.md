...
| W0-03 | Master Data / FLOW-032 | **W0-03B1 MERGED — W0-03B2 IN PROGRESS** | contract и основата са merge-нати (`d8a213a3`, `4e7814ee`, 20.09.2026); тече **B2 — pending mapping** за AI/OCR/Excel/import предложения, в отделен Draft PR | B3 (човешко resolve) и C–E (нормализация, уникалност, merge, миграция); нито един legacy route не е вързан; `MASTER_DATA_MODE` по подразбиране е `off` |
