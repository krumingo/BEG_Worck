...
> Следващ етап: **БЛОКИРАН** — W0-09A е merge-нат (`fdf4d59e`, PR #14, 14.09.2026), но **не е деплойван**; W0-10A е спрян като **UNSAFE** — M.2 NVMe кеш дисковете на NAS-а прегряват и го изключват при 70 °C (root cause установен 20.09.2026, хардуерът не е отстранен; `docs/ops/INCIDENT_2026-09-13_NAS_THERMAL.md`)
...
| W0-10 | Disaster Recovery / FLOW-044 | **PARTIAL — W0-10A BLOCKED** | `ops/synology/atlas_backup.sh` + `atlas_restore.sh` (PR #4/#5); нощен backup 03:10 работи, `gzip -t` OK, ротация 14 дни; **пропуснат backup за 14.09.2026** — NAS-ът е бил изключен | **Restore proof липсва** и **W0-10A е спрян: UNSAFE** — пет термични изключвания 13–16.09.2026 от прегряващи M.2 NVMe кеш дискове (54/57 °C на празен ход при праг 70 °C), root cause установен 20.09.2026; `docs/ops/INCIDENT_2026-09-13_NAS_THERMAL.md`; PITR, off-site immutable copy, per-tenant restore, тримесечен drill — **W0-10B** |
...
| **W0-10A** | W0-10 | изолиран restore proof на реален backup в non-production среда | **СПРЯН: UNSAFE** — прегряващи M.2 кеш дискове; алтернатива: изпълнение извън този NAS |
...
| Backup без доказан restore | W0-10A преди W0-03 — **спрян**, докато M.2 кешът не бъде свален/охладен, или се изпълни извън този NAS |
