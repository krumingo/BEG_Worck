"""
Mobile Integration Constants.

Defines available mobile modules, actions, fields, and default configurations
per role. Used by app/routes/mobile.py for mobile bootstrap and view-config
negotiation.
