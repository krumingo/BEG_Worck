...
async def get_invoice_context(project_id: str, user: dict = Depends(get_current_user)):
    ...
    if owner_id:
        if owner_type == "company":
            ...
            if c:
                client_data = {
                    ...
                    "tax_id": c.get("eik") or c.get("tax_id", ""),
                    "vat_number": c.get("vat_number", ""),
                    "responsible_person": c.get("mol", ""),
        ...
        if not client_data:
            ...
            if c:
                client_data = {
                    "id": c.get("id"),
                    "name": c.get("company_name") or c.get("companyName") or f"{c.get('first_name', '')} {c.get('last_name', '')}".strip() or c.get("name", ""),
                    "tax_id": c.get("eik") or c.get("tax_id", ""),
                    "vat_number": c.get("vat_number") or c.get("vatNumber", ""),
                    "responsible_person": c.get("mol", ""),
                    "address": c.get("address", ""),
                    "email": c.get("email", ""),
                    "phone": c.get("phone", ""),
    ...
    return {
        "project": {"id": project["id"], "code": project.get("code", ""), "name": project.get("name", "")},
        "client": client_data,
