...
COLUMN_KEYWORDS = {
    "smr_type": [
        "описание", "дейност", "наименование", "смр", "работа", "вид работа", "вид смр",
        "позиция", "артикул", "наименование на смр", "вид дейност", "строителна дейност",
        "description", "activity", "item", "work", "вид",
    ],
    "unit": [
        "мярка", "мерна", "ед.", "единица", "ед мярка", "мярка ед", "мерна единица",
        "unit", "uom", "мерна ед", "дим",
    ],
    "qty": [
        "количество", "кол.", "к-во", "кол", "брой", "бройка",
        "qty", "quantity", "amount", "бр.",
    ],
    "material_price": [
        "материал", "мат. цена", "цена мат", "цена материал", "матер.", "материали",
        "мат./ед", "цена мат.", "ед. цена мат",
        "material", "materials", "mat. price",
    ],
    "labor_price": [
        "труд", "цена труд", "работна", "трудоемкост", "труд/ед", "цена труд",
        "ед. цена труд", "работна заплата",
        "labor", "work cost", "labour",
    ],
    "total_price": [
        "обща", "стойност", "общо", "сума", "обща цена", "общо лв",
        "общо цена без ддс", "общо цена", "крайна цена", "ед. цена",
        "цена", "цена/ед", "ед цена", "стойност/ед", "unit price", "price",
        "total", "amount",
    ],
    "number": ["№", "но.", "номер", "#", "num", "n.", "ред"],
    "category": ["категория", "category", "група", "раздел"],
    "planned_man_hours": ["бюджет ч.ч.", "ч.ч.", "man_hours", "човекочасове"],
    "akord": ["акорд", "akord"],
    "planned_man_days": ["бюджет ч.д.", "ч.д.", "man_days", "човекодни"],
    "total_per_unit": ["общо труд и мат", "т+м", "труд и мат"],
    "coefficient": ["коеф", "coefficient", "коефициент"],
    "avg_daily_wage": ["средна надница", "надница", "daily_wage"],
    "hours_per_day": ["часа", "hours_per_day", "часове на ден"],
}
