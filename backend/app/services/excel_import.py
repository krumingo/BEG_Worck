...
COLUMN_KEYWORDS = {
    ...
    "unit": ["мярка", "мерна", "ед.", "единица", "unit", "мерна ед", "дим"],
    "qty": ["количество", "кол.", "к-во", "qty", "quantity", "бр.", "кол"],
    "material_price": ["материал", "мат. цена", "цена мат", "material", "мат./ед", "цена мат."],
    "labor_price": ["труд", "цена труд", "работна", "labor", "труд/ед", "цена труд"],
    "total_price": ["обща", "стойност", "общо", "total", "сума", "amount", "общо лв", "общо цена без ддс", "общо цена"],
    "number": ["№", "но.", "номер", "#", "num", "n."],
    # Construction budget specific
    "category": ["категория", "category", "група"],
